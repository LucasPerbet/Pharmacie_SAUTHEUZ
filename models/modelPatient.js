...
async function findPatient(patient) {
    ...
    try {
        const sql = "SELECT id_patient, num_secu_sociale, nom_patient, prenom_patient, DATE_FORMAT(date_naissance, '%d/%m/%Y') as date_naissance, id_mutuelle FROM `patient` WHERE id_patient = ?";
